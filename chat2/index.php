...
$(document).ready(function(){
	...
	var wsUri = "ws://gestccon.com.br:443"; 	
...
//			$('#message_box').append("<div class=\"system_msg\">"+umsg+"</div>");
	...
	websocket.onerror	= function(ev){$('#message_box').append("<div class=\"system_error\">Erro causado por - "+ev.data+"</div>");}; 
...
<div class="panel">
<input type='text' name="name" id="name" placeholder="Digite seu nome" maxlength="10" style="width:20%"  />
<input type='text' name="message" id="message" placeholder="Digite mensagem" maxlength="80" style="width:60%" />
